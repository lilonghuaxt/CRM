...
<script type="text/javascript">
	...
	function openTab(text,url,iconCls){		/* 传值 */
		if($("#tabs").tabs("exists",text)){//判断是否存在tabs选项卡了，返回false或true
...
<div region="north" style="height: 78px;background-color: #FAF0E6">
<div align="left" style="padding-top: 7px;padding-left: 50px"><font color="#654b24"  size="5"><strong>CRM客户关系管理系统</strong></font></div>
	<table style="padding: 5px" width="100%">
		<tr>
			<td valign="bottom" align="right" width="50%">
				<font size="2" style="font-family: "楷体"">&nbsp;&nbsp;<strong>欢迎：</strong>${currentUser.userName }【${currentUser.trueName }】【${currentUser.roleName }】</font>
			</td>
		</tr>
	</table>
</div>
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			...
			<div align="center" style="padding-top: 50px"><font color="red" size="10">CRM客户关系管理系统</font></div>
		</div>
	</div>
</div>
...
<%--  <jsp:include page="/WEB-INF/page/login.jsp"></jsp:include> --%>
</body>
</html>