...
public class DataDicController {
	...
	public String delete(@RequestParam(value = "ids") String ids, HttpServletResponse response) throws Exception {
		...
		for (int i = 0; i < idsStr.length; i++) {
			dataDicService.delete(idsStr[i]);
		}
		JSONObject result = new JSONObject();
		result.put("success", true);
		ResponseUtil.write(response, result);
	...
	public String dataDicComboList(HttpServletResponse response) throws Exception {
		// JSONArray jsonArray=new JSONArray();
		String dataDicName = "客户等级"; // 前台传过来的值发生乱码，解决此问题
		Map<String, Object> map = new HashMap<String, Object>();
	...
	@RequestMapping("/dataDicComboListService")
	public String dataDicComboListService(HttpServletResponse response) throws Exception {
		// JSONArray jsonArray=new JSONArray();
		String dataDicName = "服务类型"; // 前台传过来的值发生乱码，解决此问题
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("dataDicName", dataDicName);
		System.out.println(dataDicName);
		List<DataDic> dataDicList = dataDicService.find(map);
